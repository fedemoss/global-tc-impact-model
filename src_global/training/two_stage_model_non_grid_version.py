...
def loocv_predictions(df, events, features, clf_params, reg_params,
                      ...
                      output_dir=None, walk_forward=False):
    """
...
if __name__ == "__main__":
    ...
    # adm1 level
    df = df.groupby(["DisNo.", "sid", "level", "wind_sustained_flag", "GID_0", "GID_1", "iso3"]).agg({
        "wind_speed": "max",
    ...
    loocv_predictions(df=df, events=events_testing,
                           ...
                           output_dir="/data/big/fmoss/data/model_output/loocv_2_stg_model_adm1/",
                           walk_forward=False
                           )
    # loocv_predictions(df=df, events=events_testing,
    #                   features=features, clf_params=xgb_params_classifier, reg_params=xgb_params_regressor,
